...
router.get('/register', guestMiddleware, agentsController.register);

router.post('/register', uploadFile.single('avatar'), validations, agentsController.processRegister);
